...
BuildRoot: %{_tmppath}/pragmatic-infiniband-utilities-1.0.4-3
Source: pragmatic-infiniband-utilities-1.0.4.tar.gz
Requires: libibverbs, librdmacm, libibmad, opensm, infiniband-diags, whatsup, bash
